...
**373 professional terminal color schemes for Go applications**

A zero-dependency Go package providing 373 terminal color themes sourced from the [Gogh](https://github.com/Gogh-Co/Gogh) collection. All themes are compiled into pure Go code for maximum performance - no runtime YAML parsing required.
...
- **373 themes** - Professional color schemes
...
- Cycle through all 373 themes with `t` key
...
Returns a map of all 373 themes keyed by theme name.
